...
2. obrony projektu – przedstawienie:
    ...
    Należy je przesłać do końca dnia pięć dni przed spotkaniem (jeśli jest ono w inny dzień niż 15.01 i 22.02)/trzy dni przed spotkaniem (jeśli jest ono 15.01 lub 22.01).
