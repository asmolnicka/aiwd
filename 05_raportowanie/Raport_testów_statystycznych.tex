...
\begin{itemize}
    ...
    \begin{itemize}
        \item Jeśli może być coś jeszcze nieoczywistego dla czytelnika, jak wykonano podane testy statystyczne, to należy o tym zareportować.
    \end{itemize}
\end{itemize}
...
\begin{itemize}
    ...
    \item Dozwolone jest zareportowanie testu Welcha pod nazwą testu Studenta.
